-- === NETTOYAGE ET OPTIMISATION BASE DE DONNÉES (ÉTAPE 2 - CORRIGÉE) ===
...
-- 9. AJOUTER CONTRAINTES MANQUANTES pour la sécurité (syntaxe corrigée)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 10. OPTIMISER LES INDEX pour les performances
