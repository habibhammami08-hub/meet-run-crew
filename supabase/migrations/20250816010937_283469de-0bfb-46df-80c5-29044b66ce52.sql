...
-- Supprimer l'ancien schéma et créer un nouveau propre
-- =====================================================

-- 1. SUPPRESSION DE L'ANCIEN SCHÉMA
-- =====================================================

-- Supprimer les publications realtime existantes
...
DROP TRIGGER IF EXISTS update_notes_updated_at ON profiles;

-- Supprimer les vues existantes
DROP VIEW IF EXISTS sessions_with_details;

-- Supprimer les fonctions existantes (sauf celles nécessaires)
...
-- Profils utilisateurs (table principale)
...
-- Abonnements (pour compatibilité avec le système actuel)
...
-- Fonction pour création automatique de profil
...
-- Fonction pour vérifier abonnement actif
...
-- 7. STORAGE (maintenir bucket avatars existant)
-- =====================================================
...
-- 8. VUE PRINCIPALE POUR SESSIONS
-- =====================================================
...
-- 9. REALTIME POUR MISES À JOUR EN TEMPS RÉEL
-- =====================================================
